...
def return_instructions_bigquery() -> str:
    ...
    instruction_prompt_bqml_v1 = f"""
      ...
      If the user has already provided the SQL, use run_bigquery_validation tool and return the final result post query execution in raw tabular form and stop here, else follow the below steps:
      ...
      3. If the output asked by the user is in raw form, return the final result post query execution in raw tabular form and stop here, else go to step 4.
